  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-sidebar text-white flex flex-col z-50">
      <div className="p-6 border-b border-white/10">
        <h1 className="text-xl font-bold tracking-tight">DX Dashboard</h1>
        <p className="text-sm text-white/60 mt-1">Developer Experience</p>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-4 py-2">
          ...
          <div>
            ...
            <p className="text-xs text-white/50">DX Engineering</p>
          </div>
        </div>
      </div>
    </aside>
